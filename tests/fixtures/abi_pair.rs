...
unsafe extern "C" {
    ...
    fn sci_host_pair_return(left: u64, right: u64) -> PairU64;
}
...
#[unsafe(no_mangle)]
pub extern "C" fn sci_abi_call_host_pair_return(left: u64, right: u64) -> u64 {
    let value = unsafe { sci_host_pair_return(left, right) };
    value.left + value.right
}
