...
Cast aggregate arguments and returns that map to one integer register, plus
narrow two-register aggregate arguments for Pair/wide Cast shapes; unsupported
aggregate returns, Indirect, and unsupported Cast cases are rejected before
object publication.
